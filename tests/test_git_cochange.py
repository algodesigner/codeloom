...
from codeloom.core.git_cochange import (
    CommitInfo,
...
class TestEnrichGraph:
    ...
    @patch("codeloom.core.git_cochange._get_git_root", return_value=REPO_DIR)
    ...
    @patch("codeloom.core.git_cochange._is_git_repo", return_value=True)
    @patch("codeloom.core.git_cochange.parse_git_log", return_value=[])
